  ...
  return (
   <Datacss>
    <div className='home__data'>
      <h1 className='home__title'>Krupal Patel
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">
        I'm creative Developer based in Ahmedabad, and I'm very passionate and dedicated to my work.
      </p>
      <a href="mailto:krupalpatel596@gmail.com" target="_blank" className="button buttton--flex"> Say Hello<svg
